...
lo_property = lo_entity_type->create_property( iv_property_name = 'P' iv_abap_fieldname = 'P' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20241122102526'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'P'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
